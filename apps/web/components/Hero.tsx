...
export default function Hero({ lang }: { lang: string }) {
  return (
    <div className="relative bg-gradient-to-r from-maroon-dark to-maroon text-ivory py-24 lg:py-32">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button className="bg-gold hover:bg-gold-dark text-maroon-dark font-bold py-3 px-8 rounded-full transition flex items-center justify-center gap-2">
            {lang === 'en' ? 'Book Now' : 'இப்போதே முன்பதிவு செய்யுங்கள்'}
            <ArrowRight size={20} />
          </button>
          <button className="border-2 border-gold text-gold hover:bg-gold hover:text-maroon-dark font-bold py-3 px-8 rounded-full transition">
